import Animatelogo from '@/components/Companylogos/animation-logo2';
...
const Tablet = () => {
  ...
  return (
    <div className="relative bg-white w-full overflow-hidden flex flex-col items-start justify-start text-center text-base text-neutral-50 font-h300-32-medium">
      ...
      <Hero/>
      <Animatelogo/>
      <div className="bg-white w-[768px] flex flex-row items-center justify-center py-24 px-8 box-border text-21xl">
        <div className="w-[704px] flex flex-row items-center justify-center py-0 px-8 box-border">
          <div className="w-[640px] flex flex-col items-center justify-start gap-[48px]">
          <div class="w-full md:w-[640px] flex flex-col items-center justify-start gap-[32px]">
            <div class="self-stretch flex flex-col items-center justify-center gap-[16px]">
                <div class="self-stretch relative leading-[48px] font-semibold">
                Elevating Card Programs with Cutting-Edge Technology
                </div>
                <div class="relative text-lg leading-[28px] font-h50-16-bold text-neutral-400 inline-block w-full md:w-[576px]">
                consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                </div>
            </div>
            <div class="flex flex-col items-center justify-center text-base text-pri-purple-400 font-h50-16-bold">
                <div class="flex flex-row items-start justify-start">
                <div class="rounded-lg flex flex-row items-center justify-center gap-[8px]">
                    <div class="relative leading-[20px] font-medium">
                    Compare all Pro features
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                    <path d="M4.66663 9.99996H16.3333M16.3333 9.99996L10.5 4.16663M16.3333 9.99996L10.5 15.8333" stroke="#582066" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                    </svg>
                </div>
                </div>
            </div>
            </div>
            <div className="w-[640px] flex flex-col items-center justify-center gap-[32px] text-base font-h50-16-bold">
              ...
              <div className="self-stretch flex flex-col items-center justify-center p-4">
                <div className="flex flex-col items-center justify-start gap-[16px]">
                  <div className="rounded-221xl bg-pri-purple-900 flex flex-row items-center justify-center p-4">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path d="M21 2L19 4M19 4L22 7L18.5 10.5L15.5 7.5M19 4L15.5 7.5M11.39 11.61C11.9064 12.1195 12.3168 12.726 12.5978 13.3948C12.8787 14.0635 13.0246 14.7813 13.0271 15.5066C13.0295 16.232 12.8884 16.9507 12.6119 17.6213C12.3355 18.2919 11.9291 18.9012 11.4162 19.4141C10.9033 19.9271 10.294 20.3334 9.62333 20.6099C8.95271 20.8864 8.23403 21.0275 7.50866 21.025C6.7833 21.0226 6.06557 20.8767 5.39682 20.5958C4.72807 20.3148 4.1215 19.9043 3.61203 19.388C2.61016 18.3507 2.05579 16.9614 2.06832 15.5193C2.08085 14.0772 2.65928 12.6977 3.67903 11.678C4.69877 10.6583 6.07824 10.0798 7.52032 10.0673C8.96241 10.0548 10.3517 10.6091 11.389 11.611L11.39 11.61ZM11.39 11.61L15.5 7.5" stroke="#582066" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                  </div>
                  <div className="flex flex-col items-center justify-start gap-[16px]">
                    <div className="relative leading-[20px] font-medium inline-block w-[352px]">
              ...
              <div className="flex flex-col items-center justify-center text-base text-pri-purple-400 font-h50-16-bold">
                <div className="flex flex-row items-start justify-start">
                  <div className="rounded-lg flex flex-row items-center justify-center gap-[8px]">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                    <path d="M4.66663 9.99996H16.3333M16.3333 9.99996L10.5 4.16663M16.3333 9.99996L10.5 15.8333" stroke="#582066" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                  </div>
                </div>
              </div>
  ...
  <div className="flex flex-col items-center justify-center gap-[32px] text-left text-[12.36px]">
    <div className="w-full md:w-[1216px] flex flex-row items-center justify-center gap-[32px] text-left text-[19.48px]">
      <div className="relative rounded-lg bg-ghostwhite w-full md:w-[592px] h-[490px] md:h-[490px] overflow-hidden shrink-0">
        ...
        <img className="relative rounded-lg w-full h-[490px] md:h-[490px] overflow-hidden shrink-0 object-cover" alt="" src="/images/blackphone.png" />
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="59" height="55" viewBox="0 0 59 55" fill="none">
                ...
                <path d="M12 28C12 28 12.6621 34.1799 15.2411 36.7589C17.8201 39.3379 24 40 24 40C24 40 17.8201 40.6621 15.2411 43.2411C12.6621 45.8201 12 52 12 52C12 52 11.3379 45.8201 8.75891 43.2411C6.17992 40.6621 0 40 0 40C0 40 6.17992 39.3379 8.75891 36.7589C11.3379 34.1799 12 28 12 28Z" fill="url(#paint1_linear_1317_394)"/>
        <path d="M22 43C22 43 22.3311 46.09 23.6205 47.3795C24.91 48.6689 28 49 28 49C28 49 24.91 49.3311 23.6205 50.6205C22.3311 51.91 22 55 22 55C22 55 21.6689 51.91 20.3795 50.6205C19.09 49.3311 16 49 16 49C16 49 19.09 48.6689 20.3795 47.3795C21.6689 46.09 22 43 22 43Z" fill="url(#paint2_linear_1317_394)"/>
        <defs>
            <linearGradient id="paint0_linear_1317_394" x1="33" y1="0" x2="33" y2="52" gradientUnits="userSpaceOnUse">
            <stop stop-color="#814BF4"/>
            <stop offset="1" stop-color="#8E5CF7" stop-opacity="0"/>
            </linearGradient>
            <linearGradient id="paint1_linear_1317_394" x1="12" y1="28" x2="12" y2="52" gradientUnits="userSpaceOnUse">
            <stop stop-color="#814BF4"/>
            <stop offset="1" stop-color="#8E5CF7" stop-opacity="0"/>
            </linearGradient>
            <linearGradient id="paint2_linear_1317_394" x1="22" y1="43" x2="22" y2="55" gradientUnits="userSpaceOnUse">
            <stop stop-color="#814BF4"/>
            <stop offset="1" stop-color="#8E5CF7" stop-opacity="0"/>
            </linearGradient>
        </defs>
                      ...
                      <div className="flex flex-row items-start justify-start gap-[219.92px]">
                        <div className="flex flex-col items-start justify-start gap-[4.87px]">
                          ...
                          <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 21 21" fill="none">
                            <g clip-path="url(#clip0_1317_409)">
                                <path d="M3.40277 7.3293C3.40277 6.68362 3.65926 6.06439 4.11583 5.60783C4.57239 5.15127 5.19162 4.89478 5.83729 4.89478H15.5754C16.2211 4.89478 16.8403 5.15127 17.2969 5.60783C17.7534 6.06439 18.0099 6.68362 18.0099 7.3293V13.8214C18.0099 14.467 17.7534 15.0863 17.2969 15.5428C16.8403 15.9994 16.2211 16.2559 15.5754 16.2559H5.83729C5.19162 16.2559 4.57239 15.9994 4.11583 15.5428C3.65926 15.0863 3.40277 14.467 3.40277 13.8214V7.3293Z" stroke="#5A6475" stroke-width="1.21726" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M3.40277 8.95232H18.0099" stroke="#5A6475" stroke-width="1.21726" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M6.6488 13.0099H6.65765" stroke="#5A6475" stroke-width="1.21726" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M9.89484 13.0099H11.5179" stroke="#5A6475" stroke-width="1.21726" stroke-linecap="round" stroke-linejoin="round"/>
                            </g>
                            <defs>
                                <clipPath id="clip0_1317_409">
                                <rect width="19.4762" height="19.4762" fill="white" transform="translate(0.968262 0.837326)"/>
                                </clipPath>
                            </defs>
                            </svg>
                        ...
                        <g clip-path="url(#clip0_1317_416)">
                            <path d="M13.2163 4.21432H16.4623V7.46035" stroke="#2C3E50" stroke-width="1.21726" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M11.5933 9.08336L16.4623 4.21432" stroke="#2C3E50" stroke-width="1.21726" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M6.7243 17.1984H3.47827V13.9524" stroke="#2C3E50" stroke-width="1.21726" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M3.47827 17.1984L8.34732 12.3294" stroke="#2C3E50" stroke-width="1.21726" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M13.2163 17.1984H16.4623V13.9524" stroke="#2C3E50" stroke-width="1.21726" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M11.5933 12.3294L16.4623 17.1984" stroke="#2C3E50" stroke-width="1.21726" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M6.7243 4.21432H3.47827V7.46035" stroke="#2C3E50" stroke-width="1.21726" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M3.47827 4.21432L8.34732 9.08336" stroke="#2C3E50" stroke-width="1.21726" stroke-linecap="round" stroke-linejoin="round"/>
                        </g>
                        <defs>
                            <clipPath id="clip0_1317_416">
                            <rect width="19.4762" height="19.4762" fill="white" transform="translate(0.232178 0.968277)"/>
                            </clipPath>
                        </defs>
                        </svg>
                      </div>
      ...
      <div className="bg-white flex flex-row items-center justify-center py-24 px-8 text-29xl text-pri-purple-400">
        <div className="flex flex-row items-center justify-center py-0 px-8">
      ...
      <div className="bg-white flex flex-col items-center justify-center py-24 px-8 text-13xl text-neutral-100">
        <div className="flex flex-col items-center justify-center py-0 px-8">
          <div className="flex flex-col items-center justify-start gap-[48px]">
            ...
            <g clip-path="url(#clip0_1317_1042)">
      ...
      <div className="bg-white w-[768px] flex flex-col items-center justify-center py-24 px-8 box-border text-21xl">
        <div className="flex flex-col items-center justify-center py-0 px-8">
          <div className="w-[640px] flex flex-col items-center justify-start gap-[32px]">
            <div className="self-stretch flex flex-row items-center justify-center">
              <div className="flex-1 relative leading-[48px] font-semibold">
      ...
      <div className="bg-white flex flex-row items-center justify-center pt-24 px-8 pb-10 text-neutral-400 font-h50-16-bold border-t-[1px] border-solid border-neutral-1000">
        <div className="flex flex-row items-center justify-center py-0 px-8">
          <div className="w-[640px] flex flex-col items-start justify-start gap-[64px]">
            <div className="self-stretch flex flex-col items-start justify-start gap-[32px]">
              ...
              <div className="self-stretch flex flex-col items-start justify-start gap-[64px] text-left text-neutral-100">
            ...
            <div className="self-stretch flex flex-col items-center justify-start gap-[24px] text-sm">
              <div className="flex flex-row items-start justify-center">
                <div className="flex flex-row items-center justify-center gap-[24px]">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    <g clip-path="url(#clip0_1317_1831)">
